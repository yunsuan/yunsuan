...
@implementation SelectStoreCollCell
...
- (void)initUI{
    ...
    _typeL = [[UILabel alloc] initWithFrame:CGRectMake(0, 14 *SIZE, 92 *SIZE, 11 *SIZE)];
    ...
    _dropImg = [[UIImageView alloc] initWithFrame:CGRectMake(92 *SIZE, 19 *SIZE, 7 *SIZE, 4 *SIZE)];

...
@implementation MyShopRecommendCell
...
- (void)ActionTagBtn:(UIButton *)btn{
    ...
    if (self.myShopRecommendCellBlock) {
        
        self.myShopRecommendCellBlock(self.tag,btn.tag);
    }
}
...
- (void)initUI{
    ...
    _recommendL.textColor = YJContentLabColor;

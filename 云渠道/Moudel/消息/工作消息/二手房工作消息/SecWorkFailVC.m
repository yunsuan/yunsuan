...
@interface SecWorkFailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:MessageWordHouseDisabledDetail_URL parameters:@{@"survey_id":_surveyId,@"message_id":_messageId} success:^(id resposeObject) {
...
- (void)ActionComplaintBtn:(UIButton *)btn{
    ...
    ReportFailComplaintVC *nextVC = [[ReportFailComplaintVC alloc] initWithSurveyId:_surveyId];

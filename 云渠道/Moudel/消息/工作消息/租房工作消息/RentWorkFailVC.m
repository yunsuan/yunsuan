...
@interface RentWorkFailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RentWorkFailVC

- (instancetype)initWithSurveyId:(NSString *)surveyId messageId:(NSString *)messageId
{
    self = [super init];
    if (self) {
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:MessageWordRentDisabledDetail_URL parameters:@{@"survey_id":_surveyId,@"message_id":_messageId} success:^(id resposeObject) {
...
- (void)ActionComplaintBtn:(UIButton *)btn{
    ...
    RentingReportFailComplaintVC *nextVC = [[RentingReportFailComplaintVC alloc] initWithRecordId:_surveyId];

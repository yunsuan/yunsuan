...
@implementation LookWorkWaitCell
...
- (void)ActionConfirmBtn:(UIButton *)btn{
    ...
    if (self.lookWorkWaitBlock) {
        
        self.lookWorkWaitBlock(self.tag);
    }
}
...
- (void)initUI{
    ...
    _comL.textColor = YJ86Color;
    _comL.font = [UIFont systemFontOfSize:13 *SIZE];
    [self.contentView addSubview:_comL];
...
- (void)MasonryUI{
    ...
    [_confirmBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_proTypeL.mas_bottom).offset(10 *SIZE);
    ...
    [_lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_confirmBtn.mas_bottom).offset(21 *SIZE);

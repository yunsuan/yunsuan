...
@interface SecondCustomDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger _item;
    NSString *_clientId;
...
@implementation SecondCustomDetailVC

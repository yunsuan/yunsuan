    ...
    if (btn.tag < 4) {
        ...
        if (btn.tag == 1) {
            ...
            if (_is1) {
                ...
                tempArr = [NSMutableArray arrayWithArray:[self getDetailConfigArrByConfigState:SYSTEM_FUNC]];
...
- (void)initUI{
    ...
    for (int i = 0; i < 5; i++) {
        ...
        btn.frame = CGRectMake(SCREEN_Width / 5 * i, NAVIGATION_BAR_HEIGHT + 56 *SIZE, SCREEN_Width / 5, 40 *SIZE);
        btn.tag = i + 1;

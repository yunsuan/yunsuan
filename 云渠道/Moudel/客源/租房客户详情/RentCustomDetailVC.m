...
@interface RentCustomDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger _item;
    NSString *_clientId;
...
@implementation RentCustomDetailVC

...
@interface SecComRoomBrokerageVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation SecComRoomBrokerageVC
...
- (void)initDataSource{
    ...
    _titleArr = @[@"房源报备",@"房源勘察",@"客源推荐",@"客户带看",@"成交"];
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:HouseProjectGetDistrictRule_URL parameters:@{@"project_id":_projectId} success:^(id resposeObject) {

...
@interface DealRecordCell ()<UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
{
...
- (void)setData:(NSDictionary *)data{
    ...
    _propertyArr = [NSMutableArray arrayWithArray:data[@"project_tags"]];
    _tagArr = [NSMutableArray arrayWithArray:data[@"house_tags"]];

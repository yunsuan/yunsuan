...
@interface SecComRoomDetailVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate>
{
...
@property (nonatomic, strong) SecComRoomProjectVC *roomProjectVC;
...
@implementation SecComRoomDetailVC
...
- (void)ActionMaskBtn:(UIButton *)btn{
    ...
    for (UIViewController *vc in self.navigationController.viewControllers) {
        ...
        if ([vc isKindOfClass:[SecProhectSearchVC class]]) {
...
- (void)initUI{
    ...
    // 创建控制器
    _roomProjectVC = [[SecComRoomProjectVC alloc] initWithProjectId:_projectId infoid:_info_id city:_city];
    _roomProjectVC.type = self.type;
    _roomBrokerageVC = [[SecComRoomBrokerageVC alloc] initWithProjectId:_info_id];

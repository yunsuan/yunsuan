...
@implementation ReportSuccussView
...
- (void)ActionBackBtn:(UIButton *)btn{
    ...
    if (self.reportSuccussViewBackBlock) {
        
        [self removeFromSuperview];
        self.reportSuccussViewBackBlock();
    }
}

- (void)ActionConfirmBtn:(UIButton *)btn{
    
    if (self.reportSuccussViewconfirmBlock) {
        
        [self removeFromSuperview];
        self.reportSuccussViewconfirmBlock();
    }
}

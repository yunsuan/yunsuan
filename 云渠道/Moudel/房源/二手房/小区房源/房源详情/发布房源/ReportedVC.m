...
@interface ReportedVC ()<UITextFieldDelegate>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:HouseCapacityCheck_URL parameters:@{@"project_id":_projectId} success:^(id resposeObject) {

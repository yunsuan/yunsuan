...
@interface SecHouseTypeDetailVC()<UITableViewDelegate,UITableViewDataSource,YBImageBrowserDelegate>
{
...
@implementation SecHouseTypeDetailVC
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (section == 0) {
        ...
        if (section == 1) {
            ...
            header.titleL.text = [NSString stringWithFormat:@"户型房源"];
        }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        cell.titleL.text = @"户型解析";
        cell.contentL.text = @"卧室A：37m²/东南/落地窗\n卧室B：23.2m²/东南/落地窗\n卧室C：23.2m²/东南/落地窗\n客厅：23.2m²/东南/落地窗\n餐厅：13.2m²/东南/落地窗\n卫生间：13.2m²/东南/普通窗";
//        cell.contentL.text = _baseInfoDic[@"sell_point"];
        ...
        if (indexPath.section == 1) {
            ...
            if (_houseArr.count) {
                ...
                [cell.dataArr removeAllObjects];
                [cell.cellColl reloadData];
            }
            cell.collCellBlock = ^(NSInteger index) {
                
                SecHouseTypeDetailVC *nextVC = [[SecHouseTypeDetailVC alloc] initWithHouseTypeId:_houseTypeId index:index dataArr:self.dataArr projectId:_projectId infoid:_infoid];

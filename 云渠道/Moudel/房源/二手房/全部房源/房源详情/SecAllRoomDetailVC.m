...
@interface SecAllRoomDetailVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate>
{
...
@property (nonatomic, strong) SecAllRoomProjectVC *roomProjectVC;
...
@implementation SecAllRoomDetailVC
...
- (void)initUI{
    ...
    if (self.type == 1) {
        ...
        _roomProjectVC = [[SecAllRoomProjectVC alloc] initWithHouseId:_houseId city:_city];
//        _roomProjectVC.type = 
    ...
    if (self.type == 1) {
        ...
        _roomStoreProjectVC.view.frame = CGRectMake(0, 0, self.scrollView.frame.size.width, CGRectGetHeight(self.scrollView.frame));
        
        [self.scrollView addSubview:_roomStoreProjectVC.view];
    }else{
        
        _roomOfficeProjectVC.view.frame = CGRectMake(0, 0, self.scrollView.frame.size.width, CGRectGetHeight(self.scrollView.frame));

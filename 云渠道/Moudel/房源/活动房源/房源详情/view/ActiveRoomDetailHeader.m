...
@interface ActiveRoomDetailHeader ()<UIScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
{
...
@implementation ActiveRoomDetailHeader
...
- (void)ActionImgBtn{
    ...
    if (self.activeRoomDetailHeaderImgBtnBlock) {
        
        if (_imgArr.count) {
            
            self.activeRoomDetailHeaderImgBtnBlock(_nowNum, _imgArr);

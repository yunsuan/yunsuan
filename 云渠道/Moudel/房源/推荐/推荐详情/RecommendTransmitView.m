...
@implementation RecommendTransmitView
...
- (void)ActionTagBtn:(UIButton *)btn{
    ...
    if (self.recommendTransmitTagBtnBlock) {
        
        self.recommendTransmitTagBtnBlock(btn.tag);
    }
...
//    [self addSubview:alphaView];
    ...
    UIView *whiteView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_Width, 167 *SIZE + TAB_BAR_MORE)];

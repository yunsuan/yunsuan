...
#import "RentingCommunityRoomVC.h"
...
@implementation RentingCommunityRoomVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RentingComTableCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SecdaryComTableCell"];
    if (!cell) {
        
        cell = [[RentingComTableCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"SecdaryComTableCell"];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.titleL.text = @"蓝光花满厅一期";
    cell.contentL.text = @"金牛区星辉西路123号";
    cell.averageL.text = @"均价: 102356元/月/平";
    cell.onSaleL.text = @"在租34套";
//    cell.classL.text = @"合租";
    cell.attionL.text = @"关注人数：23人";
    cell.codeL.text = @"小区编号：CB6525212221";
    return cell;
}

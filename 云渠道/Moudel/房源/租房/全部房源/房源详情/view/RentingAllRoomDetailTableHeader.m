//
//  RentingAllRoomDetailTableHeader.m
//  云渠道
//
...
@interface RentingAllRoomDetailTableHeader()<UIScrollViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
{
...
@implementation RentingAllRoomDetailTableHeader
...
- (void)ActionImgBtn{
    ...
    if (self.rentingAllRoomDetailTableHeaderImgBlock) {
        
        if (_imgArr.count) {
            
            self.rentingAllRoomDetailTableHeaderImgBlock(_nowNum, _imgArr);

...
@interface RentingAllRoomStoreVC ()<UITableViewDelegate,UITableViewDataSource,YBImageBrowserDelegate,BMKPoiSearchDelegate,RoomDetailTableCell4Delegate,BMKMapViewDelegate,UIGestureRecognizerDelegate>
{
    ...
    NSString *_houseId;
    NSString *_city;
    RentingAllRoomStoreModel *_model;
...
@implementation RentingAllRoomStoreVC
...
- (void)initDataSource{
    ...
    _imgArr = [@[] mutableCopy];
    _model = [[RentingAllRoomStoreModel alloc] init];
...
- (void)SetData:(NSDictionary *)data{
    ...
    if ([data[@"basic_info"] isKindOfClass:[NSDictionary class]]) {
        ...
        _model = [[RentingAllRoomStoreModel alloc] initWithDictionary:tempDic];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1) {
        ...
        RentingAllRoomStoreCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RentingAllRoomStoreCell"];
        if (!cell) {
            
            cell = [[RentingAllRoomStoreCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"RentingAllRoomStoreCell"];
        }

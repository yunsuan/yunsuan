...
@interface MaintainModifyCustomVC ()
{
...
@implementation MaintainModifyCustomVC
    ...
    if ([self.status isEqualToString:@"添加"]) {
        ...
        [BaseRequest POST:HouseSurveyAddContact_URL parameters:dic success:^(id resposeObject) {
            ...
            if ([resposeObject[@"code"] integerValue] == 200) {
                ...
                if (self.maintainModifyCustomVCBlock) {
                    
                    self.maintainModifyCustomVCBlock(dic);
                }

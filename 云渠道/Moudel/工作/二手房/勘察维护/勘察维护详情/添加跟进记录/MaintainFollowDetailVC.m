...
- (instancetype)initWithDataDic:(NSDictionary *)dataDic
{
    ...
    if (self) {
        ...
        _dataArr = [NSMutableArray arrayWithArray:@[[NSString stringWithFormat:@"跟进时间：%@",dataDic[@"follow_time"]],[NSString stringWithFormat:@"跟进方式：%@",dataDic[@"check_way"]],[NSString stringWithFormat:@"挂牌标题：%@",dataDic[@"title"]],[NSString stringWithFormat:@"看房方式：%@",dataDic[@"check_way"]],[NSString stringWithFormat:@"挂牌价格：%@",dataDic[@"price"]],[NSString stringWithFormat:@"出售底价：%@",dataDic[@"minimum"]],[NSString stringWithFormat:@"房源等级：%@",self.levelStr],[NSString stringWithFormat:@"卖房意愿度：%@",dataDic[@"intent"]],[NSString stringWithFormat:@"买房急迫度：%@",dataDic[@"urgency"]],[NSString stringWithFormat:@"跟进内容：%@",dataDic[@"comment"]]]];

...
@interface RoomReportVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate,UITextFieldDelegate>
{
...
@property (nonatomic, strong) RoomReportSuccessVC *roomReportSuccessVC;

@property (nonatomic, strong) RoomReportWaitVC *roomReportWaitVC;

@property (nonatomic, strong) RoomReportFailVC *roomReportFailVC;

@property (nonatomic, strong) RoomReportComplaitVC *roomReportComplaitVC;
...
- (void)initUI{
    ...
    // 创建控制器
    _roomReportWaitVC = [[RoomReportWaitVC alloc] init];
    _roomReportSuccessVC = [[RoomReportSuccessVC alloc] init];
    _roomReportFailVC = [[RoomReportFailVC alloc] init];

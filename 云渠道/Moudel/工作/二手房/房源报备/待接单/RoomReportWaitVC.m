...
@interface RoomReportWaitVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RoomReportWaitVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:HouseSurveywaitGrab_URL parameters:dic success:^(id resposeObject) {

...
@implementation RoomReportFailCell
...
- (void)ActionPhoneTap{
    ...
    if (self.roomReportFailPhoneBlock) {
        
        self.roomReportFailPhoneBlock(self.tag);
    }
}
...
- (void)initUI{
    ...
    _reasonL.textAlignment = NSTextAlignmentRight;
...
- (void)MasonryUI{
    ...
    [_timeL mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.contentView).offset(-160 *SIZE);
    }];
    ...
    [_lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_reasonL.mas_bottom).offset(13 *SIZE);

...
@interface RecommendComplaintVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RecommendComplaintVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RecommendBrokerAppealList_URL parameters:dic success:^(id resposeObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RecommendComplaitCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RecommendComplaitCell"];
    if (!cell) {
        
        cell = [[RecommendComplaitCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"RecommendComplaitCell"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RecommendComplaintDetailVC *nextVC = [[RecommendComplaintDetailVC alloc] initWithRecommendId:_dataArr[indexPath.row][@"appeal_id"]];

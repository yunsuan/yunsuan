...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RecommendBrokerDisabledList_URL parameters:dic success:^(id resposeObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RecommendFailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RecommendFailCell"];
    if (!cell) {
        
        cell = [[RecommendFailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"RecommendFailCell"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RecommendFailDetailVC *nextVC = [[RecommendFailDetailVC alloc] initWithRecommendId:_dataArr[indexPath.row][@"recommend_id"]];

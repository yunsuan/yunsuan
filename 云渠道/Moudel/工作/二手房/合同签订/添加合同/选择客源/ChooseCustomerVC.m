...
@interface ChooseCustomerVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ChooseCustomerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ChooseCustomerCell"];
    if (!cell) {
...
- (void)initUI{
    ...
    _searchBar.placeholder = @"输入电话/姓名/客源编号";

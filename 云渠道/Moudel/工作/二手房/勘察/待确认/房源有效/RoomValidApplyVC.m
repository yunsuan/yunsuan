...
@implementation RoomValidApplyVC
...
- (void)ActionConfirmBtn:(UIButton *)btn{
    ...
    [BaseRequest GET:HouseRecordValue_URL parameters:dic success:^(id resposeObject) {

...
@interface AgencyEditTradeVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation AgencyEditTradeVC
...
//    }
    ...
    [BaseRequest POST:PurchaseHouseSub_URL parameters:dic success:^(id resposeObject) {
        
        NSLog(@"%@",resposeObject);
        if ([resposeObject[@"code"] integerValue] == 200) {
            
            if (self.agencyEditTradeBlock) {
                
                self.agencyEditTradeBlock();
            }

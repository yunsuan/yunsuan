//
//  LookMaintainModifyCustomDetailVC.m
//  云渠道
//
...
@implementation LookMaintainModifyCustomDetailVC
    ...
    if ([self.status isEqualToString:@"添加"]) {
        ...
        [BaseRequest POST:TakeMaintainContactAdd_URL parameters:dic success:^(id resposeObject) {
            ...
            if ([resposeObject[@"code"] integerValue] == 200) {
                ...
                if (self.lookMaintainModifyCustomDetailVCBlock) {
                    
                    self.lookMaintainModifyCustomDetailVCBlock(dic);
                }
        ...
        [BaseRequest POST:TakeMaintainContactUpdate_URL parameters:dic success:^(id resposeObject) {

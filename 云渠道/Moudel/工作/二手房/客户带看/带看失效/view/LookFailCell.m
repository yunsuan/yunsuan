...
- (void)setDataDic:(NSMutableDictionary *)dataDic{
    ...
    _demandL.text = [NSString stringWithFormat:@"需求程度：%@",dataDic[@""]];
    _customCodeL.text = [NSString stringWithFormat:@"客户编号：%@",dataDic[@""]];
    _phoneL.text = [NSString stringWithFormat:@"联系方式：%@",dataDic[@""]];
    _matchL.text = [NSString stringWithFormat:@"匹配：%@",dataDic[@""]];
    _numL.text = [NSString stringWithFormat:@"已带看房源：%@",dataDic[@""]];
...
- (void)MasonryUI{
    ...
    [_matchL mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(170 *SIZE);
    }];

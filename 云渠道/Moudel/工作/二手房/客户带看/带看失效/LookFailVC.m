...
@interface LookFailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RecommendButterDisabledList_URL parameters:dic success:^(id resposeObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LookFailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LookFailCell"];
    if (!cell) {
        
        cell = [[LookFailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"LookFailCell"];
    }

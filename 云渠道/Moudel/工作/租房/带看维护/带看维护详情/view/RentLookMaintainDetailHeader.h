//
//  RentLookMaintainDetailHeader.h
//  云渠道
//
//  Created by 谷治墙 on 2020/2/6.
...
typedef void(^RentLookMaintainDetailHeaderBlock)(NSInteger index);

@interface RentLookMaintainDetailHeader : UITableViewHeaderFooterView

@property (nonatomic, copy) RentLookMaintainDetailHeaderBlock rentLookMaintainDetailHeaderBlock;

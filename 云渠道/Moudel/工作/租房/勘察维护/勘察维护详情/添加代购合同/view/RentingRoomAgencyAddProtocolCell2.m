//
//  RentingRoomAgencyAddProtocolCell2.m
//  云渠道
//
...
@interface RentingRoomAgencyAddProtocolCell2()
{
...
@implementation RentingRoomAgencyAddProtocolCell2
...
- (void)ActionSexBtn:(UIButton *)btn{
    ...
    if (self.rentingRoomAgencyAddProtocolCell2SexBlock) {
        
        self.rentingRoomAgencyAddProtocolCell2SexBlock();
    }
}

- (void)ActionTimeBtn:(UIButton *)btn{
    
    if (self.rentingRoomAgencyAddProtocolCell2TimeBlock) {
        
        self.rentingRoomAgencyAddProtocolCell2TimeBlock();
    }
}
...
-(void)textChange:(UITextField *)textField{
    ...
    if (self.rentingRoomAgencyCell2Block) {
        self.rentingRoomAgencyCell2Block();
    }
}

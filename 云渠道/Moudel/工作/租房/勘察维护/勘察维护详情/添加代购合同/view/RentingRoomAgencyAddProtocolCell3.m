//
//  RentingRoomAgencyAddProtocolCell3.m
//  云渠道
//
...
@interface RentingRoomAgencyAddProtocolCell3()
{
...
@implementation RentingRoomAgencyAddProtocolCell3
...
-(void)textChange:(UITextField *)textField{
    ...
    if (self.rentingRoomAgencyCell3Block) {
        self.rentingRoomAgencyCell3Block(textField.text);
    }
}
...
-(void)action_change
{
    if (self.rentingChangeblock) {
        self.rentingChangeblock();
    }
}

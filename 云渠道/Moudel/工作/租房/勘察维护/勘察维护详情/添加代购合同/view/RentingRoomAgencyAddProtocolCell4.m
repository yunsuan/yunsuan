//
//  RentingRoomAgencyAddProtocolCell4.m
//  云渠道
//
...
@interface RentingRoomAgencyAddProtocolCell4 ()<UITextViewDelegate>
{
...
@implementation RentingRoomAgencyAddProtocolCell4
...
- (void)ActionPayBtn:(UIButton *)btn{
    ...
    if (self.rentingRoomAgencyAddProtocolCell4PayBlock) {
        
        self.rentingRoomAgencyAddProtocolCell4PayBlock();
    }
}

- (void)ActionTimeBtn:(UIButton *)btn{
    
    if (self.rentingRoomAgencyAddProtocolCell4TimeBlock) {
        
        self.rentingRoomAgencyAddProtocolCell4TimeBlock();
    }
}
...
-(void)textChange:(UITextField *)textField{
    ...
    if (self.rentingRoomAgencylCell4Block) {
        self.rentingRoomAgencylCell4Block(_datadic);
    }
}

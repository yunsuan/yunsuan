//
//  RentingRoomAgencyAddProtocolCell.m
//  云渠道
//
...
@interface RentingRoomAgencyAddProtocolCell()
{
...
@implementation RentingRoomAgencyAddProtocolCell
...
-(void)textChange:(UITextField *)textField{
    ...
    if (self.rentingRoomAgencyBlock) {
        self.rentingRoomAgencyBlock(self.tag,self.data);
    }
}
...
- (void)ActionAddBtn:(UIButton *)btn{
    ...
    if (self.rentingRoomAgencyAddProtocolCellBlock) {
        
        self.rentingRoomAgencyAddProtocolCellBlock(self.tag);
    }
}

- (void)ActionSexBtn:(UIButton *)btn{
    
    if (self.rentingRoomAgencyAddProtocolCellSexBlock) {
        
        self.rentingRoomAgencyAddProtocolCellSexBlock(self.tag);
    }
}

- (void)ActionCardBtn:(UIButton *)btn{
    
    if (self.rentingRoomAgencyAddProtocolCellCardBlock) {
        
        self.rentingRoomAgencyAddProtocolCellCardBlock(self.tag);
    }
}
...
- (void)initUI{
    ...
    _titleArr = @[@"性别:",@"名称：",@"联系电话：",@"联系电话2：",@"证件类型：",@"证件编号：",@"通讯地址："];

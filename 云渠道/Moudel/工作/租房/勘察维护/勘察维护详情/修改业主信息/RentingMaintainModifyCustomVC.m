//
//  RentingMaintainModifyCustomVC.m
//  云渠道
//
...
@interface RentingMaintainModifyCustomVC (){
...
@implementation RentingMaintainModifyCustomVC
    ...
    if ([self.status isEqualToString:@"添加"]) {
        ...
        [BaseRequest POST:HouseSurveyAddContact_URL parameters:dic success:^(id resposeObject) {
            ...
            if ([resposeObject[@"code"] integerValue] == 200) {
                ...
                if (self.rentingMaintainModifyCustomVCBlock) {
                    
                    self.rentingMaintainModifyCustomVCBlock(dic);
                }

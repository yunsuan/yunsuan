...
@interface RentingMaintainCustomVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RentingMaintainCustomVC
...
- (void)ActionRightBtn:(UIButton *)btn{
    ...
    nextVC.rentingMaintainModifyCustomVCBlock = ^(NSDictionary *dic) {
        ...
        [_table reloadData];
        if (self.rentingMaintainCustomVCBlock) {
            
            self.rentingMaintainCustomVCBlock();
        }
    };

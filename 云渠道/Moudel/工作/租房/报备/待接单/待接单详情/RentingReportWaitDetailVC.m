...
@interface RentingReportWaitDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RentingReportWaitDetailVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RentRecordWaitGrabDetail_URL parameters:@{@"record_id":_recordId} success:^(id resposeObject) {

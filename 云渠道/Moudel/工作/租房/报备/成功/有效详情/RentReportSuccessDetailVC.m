...
@interface RentReportSuccessDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RentReportSuccessDetailVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RentRecordValueDetail_URL parameters:@{@"survey_id":_recordId} success:^(id resposeObject) {

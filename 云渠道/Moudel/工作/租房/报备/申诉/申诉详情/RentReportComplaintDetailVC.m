...
#import "RentReportComplaintDetailVC.h"

#import "SingleContentCell.h"
#import "BaseHeader.h"
#import "BlueTitleMoreHeader.h"

@interface RentReportComplaintDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RentReportComplaintDetailVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:RentRecordAppealDetail_URL parameters:@{@"appeal_id":_appealId} success:^(id resposeObject) {

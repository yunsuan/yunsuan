...
@interface NomineeConfirmVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation NomineeConfirmVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectWaitConfirm_URL parameters:dic success:^(id resposeObject) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    confirmDetailVC *nextVC = [[confirmDetailVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];

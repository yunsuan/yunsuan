...
@interface RecommendInvalidVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation RecommendInvalidVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    InvalidVC *nextVC = [[InvalidVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];

...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectDealList_URL parameters:dic success:^(id resposeObject) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DealedVC *nextVC = [[DealedVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];

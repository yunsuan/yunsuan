...
@interface BarginUndealVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectWaitDeal_URL parameters:dic success:^(id resposeObject) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UnDealVC *nextVC = [[UnDealVC alloc] initWithString:_dataArr[indexPath.row][@"client_id"]];

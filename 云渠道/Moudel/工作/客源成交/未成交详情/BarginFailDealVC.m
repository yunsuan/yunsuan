...
@interface BarginFailDealVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation BarginFailDealVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectDealDisableList_URL parameters:dic success:^(id resposeObject) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FailedDealVC *nextVC = [[FailedDealVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];

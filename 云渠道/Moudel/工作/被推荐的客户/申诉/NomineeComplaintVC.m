...
@interface NomineeComplaintVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation NomineeComplaintVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectAppealList_URL parameters:dic success:^(id resposeObject) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_dataArr[indexPath.row][@"state"] isEqualToString:@"处理完成"]) {
        ...
        AppealComplaintedVC *nextVC = [[AppealComplaintedVC alloc] initWithAppealId:_dataArr[indexPath.row][@"appeal_id"]];
        [self.navigationController pushViewController:nextVC animated:YES];
    }else{
        
        AppealComplaintingVC *nextVC = [[AppealComplaintingVC alloc] initWithAppealId:_dataArr[indexPath.row][@"appeal_id"]];
        [self.navigationController pushViewController:nextVC animated:YES];
    }
}

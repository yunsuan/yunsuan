...
@interface NomineeInvalidVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation NomineeInvalidVC
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectDisabled_URL parameters:dic success:^(id resposeObject) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NoInvalidVC *nextVC = [[NoInvalidVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];

...
typedef void(^ReportCustomConfirmViewBlock)(void);

@interface ReportCustomConfirmView : UIView

@property (nonatomic, copy) ReportCustomConfirmViewBlock reportCustomConfirmViewBlock;

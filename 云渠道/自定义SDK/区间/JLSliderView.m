...
-(void)initView {
    ...
    self.leftTopLabel.text = [NSString stringWithFormat:@"%lu万", (unsigned long)self.minValue];
    ...
    self.rightTopLabel.text = [NSString stringWithFormat:@"%lu万", (unsigned long)self.maxValue];
